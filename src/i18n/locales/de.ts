...
export const de = {
  ...
  notebooks: {
    ...
    createTitle: "Notebook erstellen",
    nameLabel: "Name",
    namePlaceholder: "z. B. Analysis – Klausur",
    emojiLabel: "Symbol",
    subjectLabel: "Fach",
    noSubject: "Kein Fach",
    sourcesLabel: "Quellen",
    sourcesHint: "Wähle die Materialien, auf die sich dieses Notebook stützt.",
    empty: "Noch keine Notebooks",
    emptyBody:
      "Erstelle ein Notebook aus deinen Materialien. Alles, was darin entsteht, stützt sich ausschließlich auf diese Quellen.",
