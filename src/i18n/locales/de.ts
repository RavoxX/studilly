...
export const de = {
  ...
  notebooks: {
    title: "Notebooks",
    subtitle:
      "Ein Notebook bündelt ausgewählte Materialien. Frage sie im Chat oder lasse das Studio daraus Präsentationen, Mindmaps, Karteikarten, Quiz, Tabellen, Infografiken und Berichte erstellen.",
    create: "Neues Notebook",
    untitled: "Neues Notebook",
    rename: "Umbenennen",
    nameLabel: "Name",
    emojiLabel: "Symbol",
    empty: "Noch keine Notebooks",
    emptyBody:
      "Erstelle ein Notebook und füge darin deine Materialien hinzu. Name und Symbol wählt Studilly danach aus, was darin liegt.",
    sourceCount: (n: number) => (n === 1 ? "1 Quelle" : `${n} Quellen`),
    updated: (date: string) => `Zuletzt bearbeitet ${date}`,
    delete: "Notebook löschen",
    deleteConfirmTitle: "Notebook löschen?",
    deleteConfirmBody:
      "Der Chatverlauf und alle Studio-Erzeugnisse werden gelöscht. Deine Materialien bleiben erhalten.",
    ...
    sources: {
      ...
      remove: "Entfernen",
      removeLabel: (title: string) => `${title} entfernen`,
      empty: "Keine Quellen",
      emptyBody: "Füge Materialien hinzu, damit dieses Notebook etwas zu lesen hat.",
      noneAvailable: "Du hast noch keine Materialien hochgeladen.",
      processing: "Wird noch verarbeitet",
      search: "Materialien durchsuchen",
      webTitle: "Aus dem Internet",
      webPlaceholder: "https://…",
      webAdd: "Laden",
      webHint: "Studilly liest den Text der Seite und legt ihn als Material ab. Er zählt wie ein Upload.",
      libraryTitle: "Aus deinen Materialien",
      urlInvalid: "Das sieht nicht nach einer Web-Adresse aus.",
      urlUnreachable: "Diese Seite ließ sich nicht laden.",
      urlUnsupported: "Von dieser Adresse kam keine Webseite zurück.",
      urlTooLarge: "Diese Seite ist zu groß.",
      urlNoText: "Auf dieser Seite stand zu wenig Text.",
      urlLimit: "Du hast dein Upload-Kontingent aufgebraucht.",
      problemNone: "Füge zuerst eine Quelle hinzu.",
      problemProcessing: "Deine Quellen werden noch gelesen. Das dauert einen Moment.",
      problemNoText: "Aus diesen Quellen ließ sich kein Text lesen. Öffne das Material und starte die Verarbeitung neu, oder füge eine andere Quelle hinzu.",
    ...
    chat: {
      ...
      send: "Senden",
      empty: "Frag deine Quellen",
      emptyBody:
        "Jede Antwort stützt sich nur auf die Materialien in diesem Notebook – und nennt dir die Stellen, aus denen sie stammt.",
      thinking: "Liest deine Quellen …",
      citations: (n: number) => (n === 1 ? "1 Beleg" : `${n} Belege`),
      followUp: "Weiterfragen",
      noSources: "Füge zuerst eine Quelle hinzu.",
      failed: "Das hat nicht geklappt. Versuche es noch einmal.",
      limitReached: "Du hast dein Fragenkontingent aufgebraucht.",
    },

    studio: {
      title: "Studio",
      subtitle: "Aus deinen Quellen erstellt",
      generating: "Wird erstellt …",
      generatingBody: "Das dauert einen Moment.",
      empty: "Noch nichts erstellt",
      emptyBody: "Wähle oben aus, was aus deinen Quellen entstehen soll.",
      instructionLabel: "Worauf soll es sich konzentrieren? (optional)",
      instructionPlaceholder: "z. B. nur Kapitel 3, oder: für die mündliche Prüfung",
      generate: "Erstellen",
      cancel: "Abbrechen",
      delete: "Löschen",
      deleteLabel: (title: string) => `${title} löschen`,
      open: "Öffnen",
      close: "Schließen",
      noSources: "Füge zuerst eine Quelle hinzu.",
      failed: "Das hat nicht geklappt. Versuche es noch einmal.",
      limitReached: "Du hast dein Studio-Kontingent aufgebraucht.",
    },
    ...
    kindHints: {
      presentation: "Foliensatz mit Sprechernotizen",
      mindmap: "Begriffe und ihre Zusammenhänge",
      flashcards: "Vorder- und Rückseiten zum Abfragen",
      quiz: "Multiple Choice mit Erklärungen",
      table: "Vergleich in Zeilen und Spalten",
      infographic: "Kennzahlen und Ablauf",
      report: "Ausformulierte Zusammenfassung",
    },

    viewer: {
      slide: (n: number, total: number) => `Folie ${n} von ${total}`,
      speakerNote: "Sprechernotiz",
      card: (n: number, total: number) => `Karte ${n} von ${total}`,
      flip: "Umdrehen",
      showAnswer: "Antwort zeigen",
      next: "Weiter",
      previous: "Zurück",
      question: (n: number, total: number) => `Frage ${n} von ${total}`,
      checkAnswer: "Prüfen",
      correct: "Richtig",
      incorrect: "Falsch",
  ...
  usage: {
    metric: {
      ...
      notebook_chat: "Notebook-Fragen",
      notebook_artifact: "Studio-Erzeugnisse",
    },
  },
