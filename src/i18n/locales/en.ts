...
export const en: Dictionary = {
  ...
  notebooks: {
    ...
    nameLabel: "Name",
    namePlaceholder: "e.g. Calculus – final exam",
    emojiLabel: "Symbol",
    subjectLabel: "Subject",
    noSubject: "No subject",
    sourcesLabel: "Sources",
    sourcesHint: "Pick the materials this notebook draws on.",
    empty: "No notebooks yet",
    emptyBody:
      "Create a notebook from your materials. Everything made inside it draws on those sources and nothing else.",
