...
export const en: Dictionary = {
  ...
  notebooks: {
    title: "Notebooks",
    subtitle:
      "A notebook gathers the materials you choose. Ask them questions in the chat, or let the Studio turn them into presentations, mind maps, flashcards, quizzes, tables, infographics and reports.",
    create: "New notebook",
    untitled: "New notebook",
    rename: "Rename",
    nameLabel: "Name",
    emojiLabel: "Symbol",
    empty: "No notebooks yet",
    emptyBody:
      "Create a notebook, then add your materials inside it. Studilly picks the name and symbol from what is in there.",
    sourceCount: (n: number) => (n === 1 ? "1 source" : `${n} sources`),
    updated: (date: string) => `Last edited ${date}`,
    delete: "Delete notebook",
    deleteConfirmTitle: "Delete this notebook?",
    deleteConfirmBody:
      "The conversation and everything the Studio made will be deleted. Your materials are kept.",
    ...
    sources: {
      ...
      empty: "No sources",
      emptyBody: "Add materials so this notebook has something to read.",
      noneAvailable: "You haven't uploaded any materials yet.",
      processing: "Still processing",
      search: "Search materials",
      webTitle: "From the web",
      webPlaceholder: "https://…",
      webAdd: "Load",
      webHint:
        "Studilly reads the page's text and stores it as material. It counts as one upload.",
      libraryTitle: "From your materials",
      urlInvalid: "That doesn't look like a web address.",
      urlUnreachable: "That page couldn't be loaded.",
      urlUnsupported: "That address didn't return a web page.",
      urlTooLarge: "That page is too large.",
      urlNoText: "There wasn't enough text on that page.",
      urlLimit: "You've used up your upload allowance.",
      problemNone: "Add a source first.",
      problemProcessing: "Your sources are still being read. This takes a moment.",
      problemNoText: "No text could be read from these sources. Open the material and run processing again, or add a different source.",
    ...
    chat: {
      ...
      send: "Send",
      empty: "Ask your sources",
      emptyBody:
        "Every answer draws only on the materials in this notebook — and shows you the passages it came from.",
      ...
      limitReached: "You've used up your question allowance.",
    },

    studio: {
      title: "Studio",
      subtitle: "Made from your sources",
      generating: "Creating …",
      generatingBody: "This takes a moment.",
      empty: "Nothing made yet",
      emptyBody: "Choose above what your sources should become.",
      instructionLabel: "What should it focus on? (optional)",
      instructionPlaceholder: "e.g. chapter 3 only, or: for the oral exam",
      generate: "Create",
      cancel: "Cancel",
      delete: "Delete",
      ...
      noSources: "Add a source first.",
      failed: "That didn't work. Please try again.",
      limitReached: "You've used up your Studio allowance.",
    },
    ...
    kindHints: {
      ...
      mindmap: "Concepts and how they connect",
      flashcards: "Fronts and backs to test yourself",
      quiz: "Multiple choice with explanations",
      table: "A comparison in rows and columns",
      infographic: "Key figures and the sequence",
      report: "A written-out summary",
    },

    viewer: {
      slide: (n: number, total: number) => `Slide ${n} of ${total}`,
      speakerNote: "Speaker note",
      card: (n: number, total: number) => `Card ${n} of ${total}`,
      flip: "Flip",
      showAnswer: "Show answer",
      next: "Next",
      previous: "Back",
  ...
  usage: {
    metric: {
      ...
      notebook_chat: "Notebook questions",
      notebook_artifact: "Studio outputs",
    },
  },
